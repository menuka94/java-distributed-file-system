...
import org.dfs.util.controller.FileInfo;
...
import org.dfs.wireformats.ProtocolLookup;
...
public class Controller implements Node {
    ...
    private synchronized void handleLivenessHeartbeat(Event event) {
        org.dfs.wireformats.LivenessHeartbeat response = (org.dfs.wireformats.LivenessHeartbeat) event;
